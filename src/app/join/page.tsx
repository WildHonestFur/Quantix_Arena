        ...
        <main className='flex flex-col gap-[32px] row-start-2 items-center sm:items-start'>
          ...
          <div className='font-mono flex gap-4 items-center flex-col sm:flex-row'>
            ...
            <button
              ...
              className='transition-all duration-300 ease-in-out  cursor-pointer rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-secondary text-text_main gap-2 hover:bg-secondary_dark dark:hover:bg-secondary_dark font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed'
            >
