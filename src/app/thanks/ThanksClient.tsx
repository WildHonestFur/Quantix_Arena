    ...
    <>
      ...
      <div className='flex flex-col items-center min-h-screen p-8 pb-20 gap-16 sm:p-20'>
        <main className='flex flex-col gap-[32px] row-start-2 items-center sm:items-start'>
          ...
          <div className='font-mono text-2xl transition-all duration-700 text-text_secondary'>
            {name}
          </div>
          <ol className='font-mono list-inside list-decimal text-sm/6 sm:text-left transition-all duration-700 text-text_secondary'>
            <p className='mb-2 tracking-[-.01em]'>
              <span className='text-primary'>Thanks for participating in the competition! </span>
            ...
            <p className='mb-2 tracking-[-.01em]'>
              ...
              <span className='text-secondary'>wildhonestfur@gmail.com</span>
